...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="/images/ojja.jpg"  style="width:100%;height:70%;">
      </div>
      <div class="item">
        <img src="/images/lasagne.jpg"  style="width:100%;height:70%;">
      </div>
      <div class="item">
        <img src="/images/makarouna.jpg"  style="width:100%;height:70%;">
      </div>
      <div class="item">
        <img src="/images/bg5.jpg"  style="width:100%;height:70%;">
      </div>
...
<p>La dernière <strong style='color:red'>recette</strong></p>
@if($recettes != null)
<div class="container">
  <div class="row">
    <div class="col-sm-6">
